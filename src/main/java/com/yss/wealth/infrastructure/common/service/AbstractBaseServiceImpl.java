package com.yss.wealth.infrastructure.common.service;
...
import com.yss.wealth.infrastructure.common.SearchCondition;
import com.yss.wealth.infrastructure.common.dto.BusinessLogDTO;
import com.yss.wealth.infrastructure.common.mapper.BaseMapper;
import com.yss.wealth.infrastructure.constant.MqConst;
import com.yss.wealth.infrastructure.enums.BusinessOperationTypeEnum;
import com.yss.wealth.infrastructure.enums.LogTypeEnum;
...
public abstract class AbstractBaseServiceImpl<T extends BasePO, D extends BaseMapper<T>> implements IBaseService<T> {
    ...
    private static final int MAX_BATCH_NUM = 20000;
 ...
 /*       String className = this.logMapper.selectParamClassName(businessId);
        ...
        rabbitTemplate.convertAndSend(MqConst.BUSINESS_LOG_KEY, businessLog);
    }
